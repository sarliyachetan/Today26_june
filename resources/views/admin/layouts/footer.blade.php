<footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Developed By</b> Chetan Sarliya <a target="_n" href=""></a>
    </div>
    <strong>Copyright &copy; {{ date('Y') }} <a href="javascript:void(0)">Chetan Sarliya</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Morris.js charts -->
<!-- <script src="{{asset('public/master/bower_components/raphael/raphael.min.js')}}"></script> -->
<!-- <script src="{{asset('public/master/bower_components/morris.js/morris.min.js')}}"></script> -->
<!-- Sparkline -->
...
<script src="{{asset('master/dist/js/custom.js?v='.rand())}}"></script>
-@yield('js')
</body>
</html>
